        ...
        <Card padding={0}>
            ...
            <div className='my-2 p-4 flex justify-between items-center'>
                <div className='flex gap-1 items-center'>
                    <ThumbUpIcon sx={{ color: "gray", fontSize: 12 }} /> <div className='text-sm text-gray-600'>{noOfLikes} Likes</div>
                </div>
                <div className='flex gap-1 items-center'>
...

            {
                !profile && <div className='flex p-1'>
                    <div onClick={handleLikeFunc} className='w-[33%] justify-center flex gap-2 items-center border-r-1 border-gray-100 p-2 cursor-pointer hover:bg-gray-100'> {liked ? <ThumbUpIcon sx={{ fontSize: 22, color: "green" }} /> : <ThumbUpOutlinedIcon sx={{ fontSize: 22 }} />} <span>{liked ? 'Liked' : "Like"}</span> </div>
                ...
                comment && <div className='p-4 w-full'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <form className="w-full flex gap-2" onSubmit={handleSendComment} >
                            ...
                            <button type='submit' className='cursor-pointer bg-gray-700 text-white rounded-3xl py-1 px-3'>Send</button>
                        </form>
